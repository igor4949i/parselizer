...
.tools-privacy-policy-page input.button,.tools-privacy-policy-page select {
    margin: 0 1px 0 6px
}
...
.community-events [aria-hidden=true],.community-events-errors [aria-hidden=true],.community-events-errors[aria-hidden=true],.community-events-loading[aria-hidden=true],.community-events[aria-hidden=true] {
    display: none
}
...
#post-body #visibility:before,#post-body .misc-pub-comment-status:before,#post-body .misc-pub-post-status:before,#post-body .misc-pub-response-to:before,#post-body .misc-pub-revisions:before,.curtime #timestamp:before {
    color: #82878c
}
...
.privacy-text-box-head,.privacy-text-section.text-removed {
    padding-bottom: 12px
}
...
.hide-privacy-policy-tutorial .privacy-policy-tutorial,.hide-privacy-policy-tutorial .wp-policy-help {
    display: none
}
...
.policy-text div>:not(h1):not(h2):not(h3):not(h4):not(h5):not(h6):not(div):not(.privacy-policy-tutorial):not(.wp-policy-help),.policy-text>:not(h1):not(h2):not(h3):not(h4):not(h5):not(h6):not(div):not(.privacy-policy-tutorial):not(.wp-policy-help) {
    background-color: #fff;
    margin: 0;
    padding: 1em
}

.policy-text div>:not(h1):not(h2):not(h3):not(h4):not(h5):not(h6):not(div):not(.privacy-policy-tutorial):not(.wp-policy-help)+:not(h1):not(h2):not(h3):not(h4):not(h5):not(h6):not(div):not(.privacy-policy-tutorial):not(.wp-policy-help),.policy-text>:not(h1):not(h2):not(h3):not(h4):not(h5):not(h6):not(div):not(.privacy-policy-tutorial):not(.wp-policy-help)+:not(h1):not(h2):not(h3):not(h4):not(h5):not(h6):not(div):not(.privacy-policy-tutorial):not(.wp-policy-help) {
    padding-top: 0
}
...
.policy-text ol li,.policy-text ul li {
    margin-left: 2em
}
...
strong.privacy-policy-tutorial,strong.wp-policy-help {
    display: block;
    margin: 0 0 1em
}
...
div.tabs-panel-active:focus {
    box-shadow: inset 0 0 0 1px #5b9dd9,inset 0 0 2px 1px rgba(30,140,190,.8);
    outline: 0 none
}
...
.about__section.has-2-columns,.about__section.has-3-columns,.about__section.has-4-columns {
    display: -ms-grid;
    display: grid
}
...
.about__section.has-2-columns .is-section-header~.column,.about__section.has-3-columns .is-section-header~.column,.about__section.has-4-columns .is-section-header~.column {
    -ms-grid-row: 2;
    grid-row-start: 2
}

@media screen and (max-width: 782px) {
    .about__section.has-2-columns.is-wider-left,.about__section.has-2-columns.is-wider-right,.about__section.has-3-columns,.about__section.has-4-columns {
        display:block;
        padding-bottom: 16px
    }

    .about__section.has-3-columns .column:nth-of-type(n),.about__section.has-4-columns .column:nth-of-type(n) {
        padding-top: 16px;
        padding-bottom: 16px
    }
}
...
.about__container h1,.about__container h2 {
    margin-top: 0;
    font-size: 1.4em;
    line-height: 1.4
}

.about__container h2.is-smaller-heading,.about__container h3 {
    margin-top: 0;
    font-size: 1em
}
...
.errors.media-uploader-status .upload-dismiss-errors:focus::before,.errors.media-uploader-status .upload-dismiss-errors:hover::before {
    color: #c00
}
